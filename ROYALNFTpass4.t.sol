...
contract ROYALNFTTest is Test {
    ...
    function logInitialBalances() internal view {
        console.log("Initial Balances:");
        console.log("Deployer Balance:", address(deployer).balance / 1 ether, "ETH");
        console.log("Creator Balance:", address(creator).balance / 1 ether, "ETH");
        console.log("Buyer Balance:", address(buyer).balance / 1 ether, "ETH");
        console.log("Second Buyer Balance:", address(secondBuyer).balance / 1 ether, "ETH");
    }

    function logFinalBalances() internal view {
    ...
    function testBrokerNFT() public {
        ...
        console.log("Deployer Royalty:", deployerRoyalty / 1 ether, "ETH"); // Should be 1 ether
        console.log("Creator Royalty:", creatorRoyalty / 1 ether, "ETH"); // Should be 0.1 ether
        console.log("Seller Amount:", sellerAmount / 1 ether, "ETH"); // Should be 0.9 ether
    ...
    function testMultipleTransfers() public {
        ...
        console.log("Deployer Royalty:", deployerRoyalty1 / 1 ether, "ETH"); // Should be 1 ether
        console.log("Creator Royalty:", creatorRoyalty1 / 1 ether, "ETH"); // Should be 0.1 ether
        console.log("Seller Amount:", sellerAmount1 / 1 ether, "ETH"); // Should be 0.9 ether
        ...
        console.log("Deployer Royalty:", deployerRoyalty2 / 1 ether, "ETH"); // Should be 1 ether
        console.log("Creator Royalty:", creatorRoyalty2 / 1 ether, "ETH"); // Should be 0.15 ether
        console.log("Seller Amount:", sellerAmount2 / 1 ether, "ETH"); // Should be 1.85 ether
